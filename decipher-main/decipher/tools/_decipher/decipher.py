...
class DecipherConfig:
    dim_z: int = 10
    dim_v: int = 2
    #Neural network architecture for first decoder (v-->z), neural network f. 64 units
    layers_v_to_z: Sequence = (64,)
    #Neural network architecture for second decoder (z-->x), neural netowrk h. Single linear layer
