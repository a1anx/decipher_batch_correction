...
3. Other dimensionality reduction methods (PCA, UMAP, scVI, etc.)
...
print("=" * 70)
print("VISUALIZING BATCH CORRECTION RESULTS - adata_combined_2.h5ad")
print("=" * 70)
...
plt.tight_layout()
plt.savefig('batch_correction_comparison_2.png', dpi=300, bbox_inches='tight')
print("✓ Saved: batch_correction_comparison_2.png")
plt.close()
...
plt.tight_layout()
plt.savefig('batch_correction_biological_2.png', dpi=300, bbox_inches='tight')
print("✓ Saved: batch_correction_biological_2.png")
plt.close()
...
print("\nFiles created:")
print("  1. batch_correction_comparison_2.png")
