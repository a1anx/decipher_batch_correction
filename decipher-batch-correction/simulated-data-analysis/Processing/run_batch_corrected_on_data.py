"""
Run batch-corrected Decipher on adata_combined_1.h5ad
...
print("=" * 70)
print("BATCH-CORRECTED DECIPHER - Training on adata_combined_1.h5ad")
print("=" * 70)
...
results = evaluate_batch_correction(model, adata, batch_key='shift', device='cpu')
...
# Step 5: Save results
print("\n[5/5] Saving results...")
output_file = 'simulation/adata/adata_combined_1_batch_corrected.h5ad'
...
for shift_val in adata.obs['shift'].unique():
    mask = adata.obs['shift'] == shift_val
...
print("   sc.pl.umap(adata, color=['shift', 'batch_attention_strength'])")
