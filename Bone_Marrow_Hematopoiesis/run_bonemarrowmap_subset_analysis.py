...
if args.subset == 'small':
    ...
    output_file = "bonemarrowmap_small_batch_corrected.h5ad"
    default_epochs = 50
    batch_size = 128
    subset_desc = "SMALL (20k cells)"
else:  # medium
    input_file = "BoneMarrowMap_medium_90k_5kgenes.h5ad"
    output_file = "bonemarrowmap_medium_batch_corrected.h5ad"
    default_epochs = 150
    batch_size = 256
...
loss_file = f'bonemarrowmap_{args.subset}_loss_curves.png'
